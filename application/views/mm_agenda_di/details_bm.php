                            ...
                            <?php foreach($sales_items as $sales_item){?>
                                <tr>
                                    ...
                                    <?php } else{?>
                                        ...
                                        <td><input type="text" name="s_items[<?php echo $sales_item['zone_id'];?>][budget_total]" value="<?php echo $sales_item['budget_total'];?>">
                                        <td><input type="text" name="s_items[<?php echo $sales_item['zone_id'];?>][achievement_total]" value="<?php echo $sales_item['achievement_total'];?>"></td>
                                        <td><input type="text" name="s_items[<?php echo $sales_item['zone_id'];?>][target_current_month]" value="<?php echo $sales_item['target_current_month'];?>"></td>
                                        <td><input type="text" name="s_items[<?php echo $sales_item['zone_id'];?>][achievement_current_month]" value="<?php echo $sales_item['achievement_current_month'];?>"></td>
                                        <td><input type="text" name="s_items[<?php echo $sales_item['zone_id'];?>][target_next_month]" value="<?php echo $sales_item['target_next_month'];?>"></td>
                                        <td><input type="text" name="s_items[<?php echo $sales_item['zone_id'];?>][remarks_before_meeting]" value="<?php echo $sales_item['remarks_before_meeting'];?>"></td>
                                    <?php } ?>
                                </tr>
                            <?php } ?>
                            </tbody>
                            ...
                            <?php foreach($collection_items as $collection_item){?>
                                <tr>
                                    ...
                                    <?php } else{?>
                                        ...
                                        <td><input type="text" name="c_items[<?php echo $collection_item['zone_id'];?>][budget_total]" value="<?php echo $collection_item['budget_total'];?>">
                                        <td><input type="text" name="c_items[<?php echo $collection_item['zone_id'];?>][achievement_total]" value="<?php echo $collection_item['achievement_total'];?>"></td>
                                        <td><input type="text" name="c_items[<?php echo $collection_item['zone_id'];?>][target_current_month]" value="<?php echo $collection_item['target_current_month'];?>"></td>
                                        <td><input type="text" name="c_items[<?php echo $collection_item['zone_id'];?>][achievement_current_month]" value="<?php echo $collection_item['achievement_current_month'];?>"></td>
                                        <td><input type="text" name="c_items[<?php echo $collection_item['zone_id'];?>][target_next_month]" value="<?php echo $collection_item['target_next_month'];?>"></td>
                                        <td><input type="text" name="c_items[<?php echo $collection_item['zone_id'];?>][remarks_before_meeting]" value="<?php echo $collection_item['remarks_before_meeting'];?>"></td>
                                    <?php } ?>
                                </tr>
                            <?php } ?>
                            </tbody>
