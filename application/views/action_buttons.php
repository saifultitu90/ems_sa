...
?>
<?php
if(isset($action_edit_agenda))
{
    ?>
    <div class="action_button">
        <button id="button_action_edit_agenda" class="btn button_action_batch_agenda" data-action-link="<?php echo $action_edit_agenda; ?>"><?php echo $CI->lang->line("ACTION_EDIT"); ?></button>
    </div>
<?php
}
?>
<?php
if(isset($action_edit_agenda_zone))
{
    ?>
    <div class="action_button">
        <button id="button_action_edit_agenda_zone" class="btn button_action_batch_agenda_zone" data-action-link="<?php echo $action_edit_agenda_zone; ?>"><?php echo $CI->lang->line("ACTION_EDIT"); ?></button>
    </div>
<?php
}
?>
...
?>
<!-- Action button created for Meeting Minutes or Agenda -->
<!-- Created by saiful -->
<?php
...
?>
<?php
if(isset($action_forwarded))
{
    ?>
    <div class="action_button">
        <button id="button_action_edit" class="btn button_action_batch" data-action-link="<?php echo $action_forwarded; ?>"><?php echo $CI->lang->line("ACTION_FORWARD"); ?></button>
    </div>
<?php
}
?>
<?php
if(isset($action_meeting_complete))
{
    ?>
    <div class="action_button">
        <a class="btn" href="<?php echo $action_meeting_complete; ?>"><?php echo $CI->lang->line("ACTION_MEETING_COMPLETE"); ?></a>
    </div>
...
?>
<?php
if(isset($action_collection_aprroval_by_hom))
{
    ?>
    <div class="action_button">
        <a class="btn" href="<?php echo $action_collection_aprroval_by_hom; ?>"><?php echo $CI->lang->line("ACTION_COLLECTION_APPROVE"); ?></a>
    </div>
