                        ...
                        <?php foreach($sitems as $s_item){?>
                            ...
                            <tr>
                                ...
                                <?php } else{?>
                                    ...
                                    <td><input type="text" name="sitems[<?php echo $s_item['division_id']?>][last_target]" value="<?php echo $s_item['last_target'];?>"></td>
                                    <td><input type="text" name="sitems[<?php echo $s_item['division_id']?>][last_achievement]" value="<?php echo $s_item['last_achievement'];?>"></td>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <?php } else{?>
                                    ...
                                    <td><input type="text" name="citems[<?php echo $c_item['division_id'];?>][last_target]" value="<?php echo $c_item['last_target'];?>"></td>
                                    <td><input type="text" name="citems[<?php echo $c_item['division_id'];?>][last_achievement]" value="<?php echo $c_item['last_achievement'];?>"></td>
